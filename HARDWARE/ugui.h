/* -------------------------------------------------------------------------------- */
/* -- ¦ÌGUI - Generic GUI module (C)Achim D?bler, 2015                            -- */
/* -------------------------------------------------------------------------------- */
...
//
// * The ¦ÌGUI module is a free software and there is NO WARRANTY.
...
/* ========================================================================
 * Type mapping ¡ª UGUI internal types ¡ú project types (sys.h)
 * ======================================================================== */
...
/* ========================================================================
 * UGUI Configuration (embedded, no external ugui_config.h)
 * ======================================================================== */
#define USE_COLOR_RGB565            /* TK018F14LV uses RGB565 16-bit color */
#define UG_USE_MULTITASKING     1   /* Enable UG_Update() for FreeRTOS    */

#define NUMBER_OF_DRIVERS         3 /* LINE + FILL_FRAME + FILL_AREA       */
#define MAX_OBJECTS_PER_WINDOW   32 /* Object pool per window             */
#define MAX_WINDOWS               4 /* Maximum concurrent windows         */

/* Font data storage qualifier */
#define __UG_FONT_DATA           const

/* Font selection ¡ª enable commonly used sizes */
#define USE_FONT_4X6
#define USE_FONT_5X8
#define USE_FONT_6X8
